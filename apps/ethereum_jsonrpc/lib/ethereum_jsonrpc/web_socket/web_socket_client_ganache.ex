defmodule EthereumJSONRPC.WebSocket.WebSocketClientGanache do
  ...
  @impl WebSocket
  @spec json_rpc(WebSocket.web_socket(), Transport.request()) ::
  ...
  def websocket_handle({:ping, _}, _request, %__MODULE__{} = state) do
    {:reply, {:pong, ""}, state}
  end
  ...
  defp handle_response(
         %{
           ...
           "params" => %{"result" => result, "subscription" => subscription_id}
         },
  ...
  defp respond_to_registration(
    ...
    subscription = %Subscription{
      ...
      transport_options: [
        ...
        web_socket_options: %{web_socket: self()},
        url: url
      ]
    }
  ...
  defp respond_to_registration(
    ...
    new_state =
      ...
      |> put_in([Access.key!(:request_id_to_registration)], new_request_id_to_registration)
      |> update_in(
        [Access.key!(:subscription_id_to_subscription)],
